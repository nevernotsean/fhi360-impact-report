    ...
    <Layout bg={"#e2e2e2"} hideMenuButton={true}>
      ...
      <Container>
        <Masthead title={"Thank you"} headline={"2019<br/>Funders"}>
          <Box width={[1, 480]}>
            <p>
              FHI 360’s work would not be possible without the generous support
              of our funders and partners. We appreciate their crucial
              contribution and value their continued trust.
            </p>
          </Box>
        </Masthead>
        ...
        <Box width={1} minHeight={"100vh"}>
          ...
          >
            ...
            <p>
              These gifts enable us to expand our reach while deepening our
              search
              <br />
